...
const ScanQRCode = (props) => {
    ...
    let valueQRcode = ''
    if (connectedUser){
        valueQRcode = connectedUser.user_id + ";" + connectedUser.first_name + ";" + connectedUser.last_name + ";"+ connectedUser.email + ";" + serverUrl
    }
                    ...
                    <CardContent>
                        {connectedUser && (
                            <>
                                ...
                                <ListItem>
                                <ListItemText
                                    primary={"ID utilisateur: " + connectedUser.user_id}
                                />
                                </ListItem>
                                <ListItem>
                                <ListItemText
                                    primary={"Prénom et nom: " + connectedUser.first_name + " " + connectedUser.last_name }
                                />
                                </ListItem>
                                <ListItem>
                                <ListItemText
